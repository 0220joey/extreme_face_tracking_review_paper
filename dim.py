...
indoor_dump = dump_dir + '01_Indoor_'
outdoor_dump = dump_dir + '02_Outdoor_'
...
if __name__ == "__main__":
    ...
    for factor in factors:
        indoor_dump = indoor_dump + str(factor) + '/'
        ...
        for img,pts in zip(i_images,i_points):
            ...
            print(iter_count)
        iter_count = 0
        resultsDF.loc[factor_count] = ['dim','indoor_'+str(factor),total_indoor]
        outdoor_dump = outdoor_dump + str(factor) + '/'
        ...
        for img,pts in zip(o_images,o_points):
            ...
            iter_count = iter_count + 1
            print(iter_count)
        resultsDF.loc[factor_count] = ['dim','outdoor_'+str(factor), total_outdoor]
