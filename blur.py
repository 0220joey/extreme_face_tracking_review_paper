...
data_dir = '/media/drive/ibug/300W_cropped/synthetic/blur/'
dump_dir = '/media/drive/ibug/300W_cropped/results/blur/'
...
if __name__ == "__main__":
    ...
    for factor in factors:
        ...
        resultsDF.loc[factor_count] = ['blur','indoor_'+str(factor),\
        ...
        resultsDF.loc[factor_count] = ['blur','outdoor_'+str(factor),\
                total_outdoor, tot_outdoor_det, avg_outdoor_l2_error]
        factor_count = factor_count + 1
    resultsDF.to_csv('cropped_blur_results.csv',mode='a',header=True)
